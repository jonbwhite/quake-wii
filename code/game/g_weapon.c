...
extern vmCvar_t                g_pitch;
extern vmCvar_t                g_yaw;
...
void FireWeapon( gentity_t *ent ) {
	float pitch = g_pitch.value;
	float yaw = g_yaw.value;	 
	...
	ent->client->ps.viewangles[0] += pitch;
	ent->client->ps.viewangles[1] -= yaw;
